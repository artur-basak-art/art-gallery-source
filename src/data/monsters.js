...
<br/><br/>З нататкаў нячысціказнаўца Яна Клікста Лашкевіча`,
  ...
  },
  {
    name: "Кука",
    src: "Kuka",
    description: `Кука - нячысцік, якім у Беларусі палохаюць дзяцей, якія адмаўляюцца класціся спаць ноччу. Кука мае жаночую прыроду, жыве ў цемры і сама чорнага колеру. Мала каму ўдалося разгледзець дэталі яе знешнасці, але звычайна людзі адзначаюць такія рысы як крывізна, сагнутасць, вострагаловасць.
