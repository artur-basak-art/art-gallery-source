...
export default function loadMonsters() {
  return {
    data: {
      ...
      description: `
        Ілюстратар Артур Басак распачаў праект «Беларускія Нячысцікі» ў 2021 годзе, мэта гэтага праекта — папулярызацыя беларускай міфалогіі і фальклору праз шэраг ілюстрацый, выкананых у стылі аўтэнтычнага фэнтэзі і прысвечаных містычным ды міфалагічным істотам беларускага фальклору, кабінетнай міфалогіі, а таксама персанажам мясцовых легенд і міфаў.<br/><br/>
        На дадзены момант у праекце больш за 200 ілюстрацый, сярод якіх папулярныя беларускія фальклорныя персанажы: Хатнік, Ёўнік, Пуннік, Лясун, Вадзянік, Балотнік, Русалка і г.д.; Кумяльган і Вазіла - персанажы апісаныя Паўлам Шпілеўскім, якія лічацца кабінетнай міфалогіяй і крытыкуюцца навуковай супольнасцю, але ўжо сталі культавымі; знакамітыя беларускія здані - Чорная Панна Нясвіжа і Белая Панна замка ў Гальшанах.<br/><br/>
        У 2022 годзе выйшаў першы папяровы артбук з серыі, прысвечаны лясным нячысцікам і духам <a class="link" href="https://www.livelib.ru/book/1007675719-belaruskiya-nyachystsiki-lyasnyya-artur-basak" target="_blank">"Беларускія Нячысцікі: Лясныя</a>."
        `,
    },
  };
}
