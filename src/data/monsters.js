...
Паводле беларускай міфалогіі найбольшы віхор робіць адзін з самых магутных і злобных чарцей - Шатан. Кожны каго захопіць такі віхор, павінень хутчэй садзіцца ці нават лажыцца на зямлю і маліцца, каб атагнаць чорта. Калі кінуць у віхор нож, то можна трапіць у чорта, пасля гэтага віхор спыніцца і з’явіцца Шатан, які пачне прасіць дастаць нож, калі гэта зрабіць, то нячысцік будзе служыць чалавеку да самай яго смерці.`,
  ...
  },
  {
    ...
    description:
      "Трапіў я неяк на Веткаўшчыну ў час пасеву лёну. У гэтых мясцінах існуе дужа цікавы звычай клікаць палявых духаў пад час пасеву. У льнянога поля свае асабістыя духі - дзядуля Лён і яго жонка Лляніца. Мне пашчасціла пабачыць іх на свае вочы, знешне яны вельмі адрозніваюцца ад Палевіка.",
    source:
      "Міфалогія беларусаў: Энцыклапедычны слоўнік, Т.Валодзіна, С.Санько 2011;",
  },
  {
    name: "Галышка",
    src: "Galyshka",
    description: `Галышка - адна з шэрагу пачварных беларускіх русалак. Белая скура, чырвоныя вочы, лысая галава і грудзі ў іголках.
        <br/><br/>Звычайна, жыла ў жыце і лавіла непаслухмяных дзяцей, пасля прымушала іх смактаць малако з калючых грудзей. Па сваіх функцыях падобна да Цыцохі і Цыгры.`,
